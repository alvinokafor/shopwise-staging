                ...
                >
                  ...
                  <Flex gap="2" align={"center"}>
                    <Text as="label" size="3">
                      <Flex gap="2">
                        <RadioGroup.Item value="export" /> International
                        Shipping
                      </Flex>
                    </Text>
                    <Text as="label" size="3">
                  ...
                  <Flex direction={"column"} gap={"4"}>
                    ...
                    <Grid columns={"2"} gap={"4"}>
                      <Flex direction={"column"} gap={"2"}>
                        ...
                        <TextField.Input placeholder="Enter " />
                      </Flex>
            ...
            <Box className="space-y-3 col-span-2">
              <Box className="space-y-2 mt-4">
                <Box className="space-y-4 mt-4">
                  ...
                  <Flex align={"center"} justify={"between"}>
                    <Text className="text-slate-600">Weight</Text>
                    <Text className="text-slate-600">12.5kg</Text>
                  </Flex>
                  ...
                  <Flex align={"center"} justify={"between"}>
                    <Text className="text-slate-600">Customs Fee</Text>

                    <Text className="text-slate-600">NGN 0.00</Text>
                  </Flex>
